...
path = '/Users/geewiz/Desktop/2017-01-18-lachine/test-vid-stitch/'
#os.chdir('/Users/geewiz/Desktop/2017-01-18-lachine/test-batch/')
for filename in glob.glob(path +'*.png'):
    ...
    cv2.imwrite(path + os.path.basename(filename)[: -4] + '-top.png', pano_top)
    cv2.imwrite(path + os.path.basename(filename)[: -4] + '-bot.png', pano_bot)
